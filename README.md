...
🤗 Weights: [huggingface.co/ivanmikhnenkov/tinydit-256](https://huggingface.co/ivanmikhnenkov/tinydit-256) · 🌐 Author: [ivanmikhnenkov.com](https://ivanmikhnenkov.com) · 🏷️ Pretraining release: [`v1-pretrain`](https://github.com/ivanmikhnenkov/tinydit/releases/tag/v1-pretrain)
